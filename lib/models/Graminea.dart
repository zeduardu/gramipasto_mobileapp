...
class Graminea {
  ...
  Graminea({
    ...
    required this.exigenciaFertilidade,
    required this.precipiticaoMinima,
    required this.toleranciaAlagamento,
    required this.toleranciaSeca,
    required this.toleranciaFrio,
  });
